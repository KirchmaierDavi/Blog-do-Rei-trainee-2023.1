...
<body class="d-flex flex-row">
        ...
        <?php foreach ($users as $key => $user): ?>
            <div class="userlist-userboxD
                ...
                <div class="userlist-userboxD-item userlist-userboxD-actions">
                    <button type="button" class="btn btn-info" id="show-user-<?php echo $user->id ?>"
                    ...
                    <button type="button" class="btn btn-warning" id="edit-user-<?php echo $user->id ?>"
                        onclick="dashboardFunctions(this)">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                    ...
                    <button type="button" id="delete-user-<?php echo $user->id ?>" onclick="dashboardFunctions(this)"
            ...
            <div class="userlist-userboxM accordion " id="user_card_<?php echo $user->id ?>">
                <div class="accordion-item">
                    ...
                    <div id="user_card_<?php echo $user->id ?>_collapse" class="accordion-collapse collapse "
                        aria-labelledby="user_card_<?php echo $user->id ?>_head"
                        ...
                        <div class="userlist-userboxM-body accordion-body">
                            ...
                            <div class="userlist-userboxM-body-content
                                ...
                                <button type="button" class="btn btn-danger" id="delete-user-<?php echo $user->id ?>"
                                    onclick="dashboardFunctions(this)">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                        class="bi bi-trash-fill" viewBox="0 0 16 16">
                                        <path
    ...
    <div id="dashboard-functions">
        ...
        <?php foreach ($users as $user): ?>
            <div id="modal-edit-user-<?php echo $user->id ?>" data-second-id="<?php echo $user->id ?>"
                ...
                <form action="userList/update" METHOD="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="new-email" id="email" name="new-email" class="form-control"
            ...
            <div id="modal-show-user-<?php echo $user->id ?>" class="dashboard-modal shadow">
                ...
                <form>
                    <div class="form-group">
                        <label class="modal-label" for="username">Usuário (@username):</label>
                        <input type="text" id="username" disabled name="username" class="form-control text-center"
                            value="<?php echo $user->name ?>">
                    </div>
                    <div class="form-group">
                        <label class="modal-label" for="new-email" src="<?php echo $user->email ?>">E-mail:</label>
                        <input type="new-email" id="email" disabled name="new-email" class="form-control text-center"
                            value="<?php echo $user->email ?>">
                    </div>
                </form>
            </div>

            <div id="modal-delete-user-<?php echo $user->id ?>" data-second-id="<?php echo $user->id ?>"
                class="dashboard-modal shadow">
                <div class="modal-header">
